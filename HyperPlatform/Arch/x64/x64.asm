...
AsmInitializeVm PROC
    ; RSP is not 16 bit aligned when it gets called, but the following odd number (17 times) of push makes RSP 16 bit aligned.
    pushfq
    PUSHAQ              ; -8 * 16
    ...
    ; This is where the virtualized guest start to execute after successful vmlaunch.
asmResumeVm:
