...
/// @return Equivalent to #VmxStatus
inline unsigned char __vmx_on(_In_ unsigned __int64 *vms_support_physical_address) 
{
  FlagRegister flags = {};
...
/// @return Equivalent to #VmxStatus
inline unsigned char __vmx_vmclear(_In_ unsigned __int64 *vmcs_physical_address) {
  FlagRegister flags = {};
  PHYSICAL_ADDRESS physical_address = {};
...
/// @return Equivalent to #VmxStatus
inline unsigned char __vmx_vmptrld(_In_ unsigned __int64 *vmcs_physical_address)
{
  FlagRegister flags = {};
  PHYSICAL_ADDRESS physical_address = {};
  physical_address.QuadPart = *vmcs_physical_address;
...
/// @return Equivalent to #VmxStatus
inline unsigned char __vmx_vmread(_In_ size_t field, _Out_ size_t *field_value) 
{
  FlagRegister flags = {};
  __asm {
    pushad
