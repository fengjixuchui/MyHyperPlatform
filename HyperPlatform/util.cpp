...
// Initializes utility functions
{
    ...
    ASSERT(g_MmAllocateContiguousNodeMemory);//win8以前用MmAllocateContiguousMemory
...
// Allocates continuous physical memory
{
    ...
    return MmAllocateContiguousNodeMemory(number_of_bytes, lowest_acceptable_address, highest_acceptable_address, boundary_address_multiple, PAGE_READWRITE, MM_ANY_NODE_OK);//注意版本。
}
